    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">You Can Active Your Welcome Page Or Deactive it Here</div>
                 <div class="panel-body">

                  @if ($body->status == 1)
                    <form class="form-horizontal" role="form" method="POST" 
                     action="{{ url('welcome-page-settings/body-setting/update/disablesite', Auth::user()->id) }}"
                    ...
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            name="title" value="{{ $body->title }}" required>
                            @if ($errors->has('title'))
                    ...
                    <div class="form-group{{ $errors->has('titleF_User') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            name="titleF_User" value="{{ $body->titleF_User }}" required>
                    ...
                    <img src="/uploads/images/body_setting/{{ $body->picture }}" alt="picture here" class="img-thumbnail">
                  </div>
                    ...
                    <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                                <textarea name="description">{{ $body->description }}</textarea>
                    ...
                    <div class="form-group{{ $errors->has('descriptionF_User') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                                <textarea name="descriptionF_User">{{ $body->descriptionF_User }}</textarea>
                  ...
                  @endif
                    ...
                    @if ($body->status == 0)
                        <form class="form-horizontal" role="form" method="POST" 
                     action="{{ url('welcome-page-settings/body-setting/update/enablesite', Auth::user()->id) }}">
                     {{ csrf_field() }}
                     <div class="form-group">
