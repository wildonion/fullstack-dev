...
<div class="container" align="center" style="margin-top: 15em;">
  <img src="/error_mismatch.png" alt="please_search_something" 
     width="200" height="100" class="img-responsive" />
          <!-- if user's ip was for IR -->
          <p>شرمنده درخواستت فعلا نامعتبره دوباره سعی کن لطفا</p>
          <!-- if user's ip was foreign -->
         <!--  <p>Sorry your request at this moment is invalid, try again</p> -->
</div>		
