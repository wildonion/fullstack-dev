...
<body>
    ...
    <div id="wrapper">
        <div id="chatSection">
            ...
            <!-- <input type="hidden" value="{{ Auth::user()->status }}" id="authStatus"> -->
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    <li class="sidebar-brand">
                        <a href="#">
                           <strong style="color: yellow;"> {{Auth::user()->name}} CONTACTS</strong>
                        </a>
                    </li>
                    <hr>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="chat-info">
                                <h2><span class="label label-success">Welcome to the PLC</span></h2>
                                <p><span class="label label-default">Choose one of your friend from left sidebar to make a conversion.</span></p>
                            </div>
