...
<?php include'templyricsidforedit.php'; ?>
<?php include'templyricsemailforedit.php'; ?>
<?php include'fetchlyricsforedit.php'; ?>
<!DOCTYPE html>
<html lang="fa">
	<head>
		<meta charset="UTF-8">
  ...
  <div class="box fade-in one">
	<div id='container'>
		...
		<div style="border: 1px solid; background-color: #ffffcc;">
				...
				<span align="center"><?php echo $lyricstxt['lyrics']; ?></span>
		</div>
		
		<h1>Use The Tinymce Editor To Edit Your Translated Lyrics ;-)</h1>
		<p class='info'>Edit something in the editor and click Edit</p>
			...
			<textarea id='main_editor' name='editor'>
				<?php include'fetchtranslyricsforedit.php'; ?>
			</textarea>
