<div class="col-lg-8">
 <div class="panel panel-success">
    ...
    <div class="panel-body">
    	<?php 
    	    include'assets/deletelyrics.php'; 
                 ...
                 echo "
                        ...
                        <tbody>
                           <tr>
                              ...
                              </td><td><a class=\"btn btn-error\" href=\"?delete_id=". $ly['l_id'] ." title=\"click for delete\" onclick=\"return confirm('sure to delete ?')\"><span class=\"glyphicon glyphicon-remove-circle\"></span> Delete</a>
                              <td><a class=\"btn btn-error\" href=\"assets/tinymce-edit/index?see_id=". $ly['l_id'] ." title=\"click for see\" onclick=\"return confirm('sure to see ?')\"><span class=\"glyphicon glyphicon-eye-open\"></span> Show</a>
                              </td>
                              </td>
                           </tr>
                        </tbody>
