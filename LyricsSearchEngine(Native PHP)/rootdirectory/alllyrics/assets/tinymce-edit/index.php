<?php include'tempidforadminseelyrics.php'; ?>
<!DOCTYPE html>
<html lang="fa">
	<head>
		<meta charset="UTF-8">
...
<body>
  ...
  <div class="box fade-in one">
	<div id='container'>
		...
		<h1>Use The Tinymce Editor To Edit Your Lyrics ;-)</h1>
		<p class='info'>Edit something in the editor and click Edit</p>
			...
			<textarea id='main_editor' name='editor'>
				<?php include'fetchlyricsforsee.php'; ?>
			</textarea>
