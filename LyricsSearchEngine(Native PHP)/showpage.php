...
<head>
      ...
      <link rel="stylesheet" type="text/css" href="assets/livesearch.css">
      <link rel="stylesheet" type="text/css" href="assets/fadecss.css">
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.0/jquery.min.js"></script>
         <!-- live search code here -->
      <script src="assets/livesearch.js"></script>
...
<form action="showlyrics/resultpage/showlyrics" method="post">
    <div class="content">
      	<input type="text" name="search" class="search" id="searchid" placeholder="name of music + name of singer" autocomplete="off">
        <div id="result"></div>
    </div>
