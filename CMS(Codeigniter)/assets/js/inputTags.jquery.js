(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            ...
            minLength: 'Attention, Your tag must have a minimum of %s characters.',
            maxLength: 'Attention, your tag should not exceed %s characters.',
            max: 'Attention, the number of tags should not exceed %s.',
            email: 'Attention, The email address you entered is not valid',
